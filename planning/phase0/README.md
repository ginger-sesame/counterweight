...
Existing Phase 0 validation command: `python3 scripts/planning/validate_phase0.py`. Future application commands in PROOFS.md are explicitly marked planned and must not be reported as executed.
