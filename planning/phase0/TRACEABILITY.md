...
| E-01 | Clean setup -> two live Graph reads -> normalized bounded tuning -> authorized update -> quote -> real SwapVM fill -> accounting assertion -> unsafe fill rejected -> forbidden policy action denied. All steps share traceable run/configuration identities. | `npm run test:mvp`; `node scripts/proofs/mvp.mjs`; [P5 reproduction](../phase5/README.md) | [P5 clean validation](../phase5/evidence/validation.md) | PASS |
| E-02 | Inject stale data and recover; change inventory between quote/fill; fail settlement; pause and resume; revoke operator. Assert expected state after each step. | `npm run test:mvp`; `node scripts/proofs/mvp.mjs`; [P5 reproduction](../phase5/README.md) | [P5 clean validation](../phase5/evidence/validation.md) | PASS |
| E-03 | Restart the runner/service; verify configuration provenance, freshness state, and duplicate/retry behavior do not cause unintended repeated operations. If no persistent service exists, test the equivalent rerun semantics. | `npm run test:mvp`; `node scripts/proofs/mvp.mjs`; [P5 reproduction](../phase5/README.md) | [P5 clean validation](../phase5/evidence/validation.md) | PASS |
| E-04 | Another agent follows the documented setup and reproduces gates without hidden local files. Compare assertions rather than volatile transaction IDs or market values. | `npm run test:mvp`; `node scripts/proofs/mvp.mjs`; [P5 reproduction](../phase5/README.md) | [P5 handoff](../phase5/README.md) | IN PROGRESS |
| E-05 | Inspect artifacts/logs for missing identifiers and secrets; verify each gate links to exact commands and evidence and every required test has a recorded result. | `npm run test:mvp`; `node scripts/proofs/mvp.mjs`; [P5 reproduction](../phase5/README.md) | [P5 handoff](../phase5/README.md) | IN PROGRESS |
...
P5-A update 2026-09-09: E-01–E-03 pass with 97 assertions and 8 continuous settlement scenarios at runtime `57e6e67`. Clean deterministic checks and F1/F2/F3/F4 public CLI proofs pass; [validation](../phase5/evidence/validation.md). E-04 independent-agent reproduction and E-05 final package acceptance remain pending; Phase 5 is not complete.
