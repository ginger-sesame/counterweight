...
try {
 ...
 let extra={};
 if(extension) extra=await extension({client,read,send,setup,state,attempt,check,maker,taker,W,U,erc20,controllerAbi,routerAbi,normalSnapshot,options,transactions,scenarios});
 else {
